...
export class XiangqiGame {
    ...
    isValidMove(fromRow: number, fromCol: number, toRow: number, toCol: number): boolean {
        ...
        switch (piece.type) {
            case 'GENERAL': basicMoveValid = this.validateGeneralMove(fromRow, fromCol, toRow, toCol, piece.player); break;
            case 'ADVISOR': basicMoveValid = this.validateAdvisorMove(fromRow, fromCol, toRow, toCol, piece.player); break;
            case 'ELEPHANT': basicMoveValid = this.validateElephantMove(fromRow, fromCol, toRow, toCol, piece.player); break;
            ...
            case 'SOLDIER': basicMoveValid = this.validateSoldierMove(fromRow, fromCol, toRow, toCol, piece.player); break;
        }
    ...
    onTimerUpdate(cb: (elapsed: number) => void) { this.timerUpdateListeners.push(cb); }
    ...
    private notifyTimerUpdate() { this.timerUpdateListeners.forEach(cb => cb(this.elapsedTime)); }
